 ...
 @section('content')
     ...
     <x-admin.phead title="Dashboard" subtitle="An easy way to manage sales with care and precision.">
                         ...
                         <svg class="alert-green-bg-shape" viewBox="0 0 100 100" fill="none"
                             ...
                             <g transform="translate(50,50)">
                                 <rect x="-6" y="-45" width="12" height="90" rx="6" ry="6"
                                     fill="#B4F105" />
                                 <rect x="-6" y="-45" width="12" height="90" rx="6" ry="6"
                                     fill="#B4F105" transform="rotate(60)" />
                                 <rect x="-6" y="-45" width="12" height="90" rx="6" ry="6"
                                     fill="#B4F105" transform="rotate(120)" />
                             </g>
                         </svg>
                     </div>
                 </div>
                                 ...
                                 <div class="dropdown">
                                     ...
                                     <ul class="dropdown-menu dropdown-menu-end dropdown-menu-custom">
                                         ...
                                         <li><a class="dropdown-item" href="#"><i
                                                     class="bi bi-file-earmark-arrow-down"></i> Export
                                                 Report</a></li>
                                         <li>
                                             <hr class="dropdown-divider">
                                         </li>
                                         <li><a class="dropdown-item text-danger" href="#"><i
                                                     class="bi bi-eye-slash"></i> Hide Details</a>
                                         </li>
                                     </ul>
                                 </div>
                             </div>
                     ...
                     <div class="card h-100 flex-grow-1">
                         <div class="card-header">
                             ...
                             <div class="dropdown">
                                 ...
                                 <ul class="dropdown-menu dropdown-menu-end dropdown-menu-custom">
                                     <li><a class="dropdown-item" href="#"><i class="bi bi-funnel"></i>
                                             Filter Status</a></li>
                                     <li><a class="dropdown-item" href="#"><i
                                                 class="bi bi-file-earmark-arrow-down"></i> Export CSV</a>
                                     </li>
                                 </ul>
                             </div>
                         </div>
                 ...
                 <div class="col-md-5 d-flex flex-column">
                     <div class="card h-100 flex-grow-1">
                         ...
                         <div class="progress-container">
                             ...
                             <div class="progress" role="progressbar" aria-label="Product Sold Progress"
